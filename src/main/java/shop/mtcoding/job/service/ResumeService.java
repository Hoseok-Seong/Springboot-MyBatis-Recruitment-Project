...
public class ResumeService {
    ...
    public void 이력서수정(int id, ResumeUpdateReqDto resumeUpdateReqDto, int principalId) {
        ...
        int result = resumeRepository.updateById(id, resumeUpdateReqDto.getContent(),
                resumeUpdateReqDto.getCareer(), resumeUpdateReqDto.getSkill(), resumeUpdateReqDto.getAward(), resumeUpdateReqDto.getAddress(),
                resumeUpdateReqDto.getLink(), resumeUpdateReqDto.getEducation(), resumeUpdateReqDto.getFile(), resumeUpdateReqDto.getLanguage());
