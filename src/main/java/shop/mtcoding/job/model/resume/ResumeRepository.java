...
public interface ResumeRepository {
        ...
        public int updateById(@Param("id") int id,
                        @Param("content") String content, @Param("career") String career, @Param("skill") String skill, @Param("award") String award, 
                        @Param("address") String address, @Param("link") String link, @Param("education") String education, @Param("file") String file,
