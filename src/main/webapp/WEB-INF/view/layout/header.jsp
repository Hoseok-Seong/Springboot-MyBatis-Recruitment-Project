                                ...
                                <ul class="navbar-nav m-auto">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link text-dark" data-toggle="modal" data-target="#login" href="/loginForm">로그인</a>
                                            </li>
                                            <li class="nav-item">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <ul class="nav my-nav-tabs nav-fill mb-4">
                        <li class="nav-item">
                            <a class="my-nav-link list-group-item list-group-item-action active" data-toggle="tab"
